  ...
  try {
    ...
    for (const number of numbers) {
      const payload = {
        ...
        openTicket: "0",
        queueId: "0",
        body: `🚨 Alerta de Segurança! 🚨\n\nO motorista saiu do raio de segurança!\n\nNome: José da Silva Lopes\nPlaca: DBC-9A82\n\nOrigem: São Paulo - SP, ( Usiminas - Cubatão).\nEndereço: Av. Libertador, N° 115.\n\nDestino: Rio Grande do Sul -RS, (Paradiso Giovanella - Caxias do Sul).\nEndereço: Rua do trabalhador, N° 221.\n\n📍 Localização: Aqui coloca um link para chamar a nossa página web do mapa para mostrar a rota e a posição atual do veículo.
